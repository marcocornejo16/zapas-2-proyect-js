        ...
        <code>CATEGORIA - ${zapaFavorite.categoria}</code>
                ...
                <div class="information-card row">
                    <section class="col-4" >
                        ...
                        <p>En 6 cuotas el interes es de un 10%: <b>$${Math.round((zapaFavorite.price * 1.10) /6)}</b></p>
                                        <p>En 12 cuotas el interes es de un 15%: <b>$${Math.round((zapaFavorite.price * 1.15) /6)}</b></p>
